...
// classe do plano de fundo com multiplas camadas
class Background {
  constructor() {
    this.x = 0;
    this.y = 0;
...
// carrega as imagens das camadas do fundo
  create() {
...
// atualiza a posicao das camadas do fundo com base na curva da estrada e velocidade do jogador
...
// renderiza as camadas do fundo na tela
  /**
   *
   * @param {Render} render
   * @param {Camera} camera
