class Render { // Classe responsável pela renderização
  /**
   *
...
// desenha um retângulo arredondado na tela
  roundRect(color, x, y, width, height, radius = 5, fill, stroke = true) {
    const { renderingContext } = this;
// define os raios para cada canto do retângulo
    const radii = {
      tl: 0, tr: 0, br: 0, bl: 0,
    };
    ...
    renderingContext.closePath();
// preenche e/ou contorna o retângulo arredondado
    if (fill) {
      renderingContext.fill();
    }
    if (stroke) {
