...
// classe que representa um segmento da pista de corrida
class SegmentLine {
  scale = 0;
  index = 0;
  curve = 0;
...
// projeta o segmento na tela com base na posição da câmera
  /**
   * 
   * @param {Camera} camera 
   */
...
// desenha os sprites do segmento
  /**
   * 
   * @param {Render} render 
   * @param {Camera} camera 
...
// desenha a face esquerda do túnel se estiver visível
...
// desenha a face direita do túnel se estiver visível
...
// desenha a face central do túnel se estiver visível
...
// desenha o título do túnel se existir
          if (tunnel.title) {
...
// obtém o segmento anterior do túnel
        const previousSegment = tunnel.previousSegment;
        // verifica se o segmento anterior existe
        if (previousSegment) {
...
// desenha as coberturas do túnel se estiverem visíveis
...
// exporta a classe SegmentLine para uso em outros módulos
